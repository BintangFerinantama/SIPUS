            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-gray-600">
                                Kelola semua tag yang digunakan untuk mengorganisir file
                            </p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div v-if="tags.data.length > 0">
                                        ...
                                        <td v-if="canManage" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-2">
                                                ...
                                                <button
                                                    ...
                                                    title="Delete Tag"
                                                    :disabled="tag.files_count > 0"
                                                    :class="{ 'opacity-50 cursor-not-allowed': tag.files_count > 0 }"
                                                >
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Pagination -->
                        <div v-if="tags.last_page > 1" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                            <div class="flex items-center justify-between">
                    ...
                    <div v-else class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada tag</h3>
                        <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat tag pertama.</p>
        ...
        >
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" @click.stop>
                <div class="mt-3">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mt-4 text-center">Hapus Tag</h3>
