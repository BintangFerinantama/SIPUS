                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            >
                                <div>
                                    ...
                                    >
                                    <span
                                        class="ml-2 font-mono text-gray-900"
                                        >{{ tag.slug }}</span
                                    >
                                </div>
                                <div>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>
                                    ...
                                    {{ tag.files_count }} file(s). Mengubah nama
                                    tag akan mempengaruhi semua file yang
                                    menggunakan tag ini.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>
                                        Slug akan otomatis diperbarui
                                        berdasarkan nama baru
                                    </li>
                                    <li>
                                        Pastikan nama tag tetap deskriptif dan
                                        mudah dipahami
                                    </li>
                                    <li>
                                        Perubahan akan langsung terlihat di
                                        semua file yang menggunakan tag ini
                                    </li>
                                </ul>
                            </div>
                        </div>
