            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-gray-500">Tambah Tag</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <p class="mt-2 text-gray-600">
                        Buat tag baru untuk membantu mengorganisir file-file dalam sistem
                    </p>
                </div>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Tips Membuat Tag</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Gunakan nama tag yang deskriptif dan mudah dipahami</li>
                                    <li>Hindari menggunakan karakter khusus yang tidak perlu</li>
                                    <li>Tag akan secara otomatis dibuat slug-nya untuk URL</li>
                                    <li>Tag yang sama tidak bisa dibuat dua kali</li>
                                </ul>
                            </div>
                        </div>
                    </div>
